...
def onnx_to_trt(onnx_path: str,
    ...
    b.create_network(onnx_path, end2end, conf_thres, iou_thres, max_det, v8=v8, v10=v10, no_class_agnostic=no_class_agnostic)
    b.create_engine(engine_path, precision, calib_input, calib_cache, calib_num_images, calib_batch_size)
