...
class VisualizePage(QWidget):
    ...
    def __init__(self, parent):
        ...
        self.view.setStyleSheet(
            "color: #FFFFFF; font-size:18px; font-family: Inter; background-color: #1E1E1E; border: 2px dashed #444;"
        )
    ...
    def on_image(self, img, boxes=None, scores=None, cls_inds=None, conf=None):
        ...
        if dt > 0:
            ...
            self._dt_ema = (
                dt if self._dt_ema is None else (1 - alpha) * self._dt_ema + alpha * dt
            )
        ...
        try:
            ...
            rect_h = fm.height() + 4
            painter.fillRect(
                x - 4, y - fm.ascent() - 2, rect_w, rect_h, QColor(0, 0, 0, 120)
            )
